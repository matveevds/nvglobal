            ...
            <div class="video-intro__wrapper section__wrapper">
                ...
                <div class="video-intro__player">
                    <video class="video-intro__video"
                           src="<?php echo get_template_directory_uri(); ?>/video/nvglobal_video.mp4#t=0.1"
                           preload="metadata"
                           playsinline
                    ...
                    <button type="button" class="video-intro__play" aria-label="Play video introduction">
                        <svg class="video-intro__play-icon" width="36" height="36" viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false">
                            <path d="M8.25 5.799c0-1.246 1.358-2.018 2.428-1.381l9.6 5.701c1.04.617 1.04 2.144 0 2.762l-9.6 5.701c-1.07.637-2.428-.135-2.428-1.381V5.799Z" fill="currentColor"/>
                        </svg>
                    </button>
                </div>
            </div>
